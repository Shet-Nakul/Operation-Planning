...
router.put('/pattern/:id', auth_1.authenticateJWT, forbiddenPatternsController_1.updateForbiddenPattern);
router.delete('/pattern/:id', auth_1.authenticateJWT, forbiddenPatternsController_1.deleteForbiddenPattern);
